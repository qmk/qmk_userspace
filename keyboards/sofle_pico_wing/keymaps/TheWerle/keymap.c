...
enum custom_keycodes {
	 ...
	 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
	 * |  `   |   1  |   2  |   3  |   4  |   5  |                    |   6  |  7   | 8    | 9    | DLine| Bspc |
	 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
	 * | Tab  |   !  |   @  |   #  |   $  |   %  |-------.    ,-------|   ^  |  4   | 5    | 6    |  Del | Bspc |
	 * |------+------+------+------+------+------|RGB_TOG|    |       |------+------+------+------+------+------|
	 * | Shift|  =   |  -   |  +   |   {  |   }  |-------|    |-------|   [  |  1   | 2    | 3    | Shift|
	 * `-----------------------------------------/       /     \      \-----------------------------------------'
	 *            | LGUI | LAlt | LCTR |Space | / LOWER /       \RAISE \ ENT |  0   |  .   | +    |
	 */
	[_LOWER] = LAYOUT(
	  QK_GESC,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
	  _______,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5, KC_6,    KC_KP_7, KC_KP_8, KC_KP_9, KC_PSLS, KC_F12,
	  _______, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC, KC_CIRC, KC_KP_4, KC_KP_5, KC_KP_6, KC_PAST, KC_PIPE,
	  _______,  KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, KC_LBRC, KC_KP_1, KC_KP_2, KC_KP_3, KC_PMNS, _______,
	  _______, _______, _______, _______, _______, RGB_TOG, _______, _______, KC_KP_0, KC_DOT,  KC_PPLS, _______
    ),
	/* RAISE
	 * ,----------------------------------------.                    ,-----------------------------------------.
	 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
	 ...
	 * `-----------------------------------------/       /     \      \-----------------------------------------'
	 *            | LGUI | LAlt | LCTR |Space | / LOWER /       \Enter\ RAISE| RCTR | RAlt | RGUI |
	 */
    [_RAISE] = LAYOUT(
	 ...
	 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
	 * |QK_BOOT|     |RGBSp-|RGBV- |RGBS- |RGBH- |                    |      |MU_NEXT|      |MU_ON|MU_OFF|MU_TOGG|
	 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
	 ...
	 */
      ...
      QK_BOOT, XXXXXXX, RGB_SPD, RGB_VAD, RGB_SAD, RGB_HUD, XXXXXXX,  MU_NEXT, XXXXXXX,  MU_ON,  MU_OFF, MU_TOGG,
